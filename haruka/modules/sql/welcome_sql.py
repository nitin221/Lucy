...
DEFAULT_WELCOME = "{first} is here to kick butt and chew bubblegum. And {first} is all out of gum."
DEFAULT_GOODBYE = "Good luck finding better shitposters than us, {first}!"
